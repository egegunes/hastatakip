...
class HastaUpdateViewTestCase(TestCase):
    ...
    def test_post(self, *args):
        request = self.factory.post(
            reverse("hasta:update", kwargs=self.kwargs), self.data
        )
        request.user = self.user
...
class HastaDetailViewTestCase(TestCase):
    ...
    def test_post(self):
        request = self.factory.post(
            reverse("hasta:detail", kwargs=self.kwargs), {"sozlesme": "Onayla"}
        )
        request.user = self.user
...
class MuayeneListViewTestCase(TestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("hasta:muayene-list", kwargs=self.kwargs), data
        )
        request.user = self.user
...
class ReceteListViewTestCase(TestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("hasta:recete-list", kwargs=self.kwargs), data
        )
        request.user = self.user
...
class RaporListViewTestCase(TestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("hasta:rapor-list", kwargs=self.kwargs), data
        )
        request.user = self.user
...
class LabIstekListViewTestCase(TestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("hasta:istek-list", kwargs=self.kwargs), data
        )
        request.user = self.user
