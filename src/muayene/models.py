...
class Ilac(models.Model):
    ...
    bilgi = models.CharField(
        max_length = 30,
        blank = True,
        null = True
    )
    kullanim = models.CharField(
        max_length = 30,
        null = True,
        blank = True
    )
...
class LaboratuvarIstek(models.Model):
    ...
    hemogram = models.BooleanField(
        default = False,
        verbose_name = "Hemogram"
    )
    ...
    sedim = models.BooleanField(
        default = False,
        verbose_name = "Sedim"
    )
    sedim_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    serum_demir = models.BooleanField(
        default = False,
        verbose_name = "Serum Demir"
    )
    ...
    tdbk = models.BooleanField(
        default = False,
        verbose_name = "TDBK"
    )
    tdbk_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    ferritin = models.BooleanField(
        default = False,
        verbose_name = "Ferritin"
    )
    ...
    b12_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    folik_asit = models.BooleanField(
        default = False,
        verbose_name = "Folik asit"
    )
    ...
    hemoglobin = models.BooleanField(
        default = False,
        verbose_name = "Hemoglobin Elektroforezi"
    )
    ...
    aclik_kan = models.BooleanField(
        default = False,
        verbose_name = "Açlık Kan Şekeri"
    )
    ...
    tokluk_kan = models.BooleanField(
        default = False,
        verbose_name = "Tokluk Kan Şekeri"
    )
    ...
    hba1c = models.BooleanField(
        default = False,
        verbose_name = "HbA1c"
    )
    hba1c_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    sgot = models.BooleanField(
        default = False,
        verbose_name = "SGOT (AST)"
    )
    sgot_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    sgpt = models.BooleanField(
        default = False,
        verbose_name = "SGPT (ALT)"
    )
    sgpt_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    ggt = models.BooleanField(
        default = False,
        verbose_name = "GGT"
    )
    ggt_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    alp = models.BooleanField(
        default = False,
        verbose_name = "ALP"
    )
    alp_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    ure = models.BooleanField(
        default = False,
        verbose_name = "Üre"
    )
    ure_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    kreatinin = models.BooleanField(
        default = False,
        verbose_name = "Kreatinin"
    )
    ...
    urik_asit = models.BooleanField(
        default = False,
        verbose_name = "Ürik asit"
    )
    ...
    hdl_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    trigliserit = models.BooleanField(
        default = False,
        verbose_name = "Trigliserit"
    )
    ...
    ldl = models.BooleanField(
        default = False,
        verbose_name = "LDL"
    )
    ldl_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    free_t3 = models.BooleanField(
        default = False,
        verbose_name = "Free T3"
    )
    free_t3_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    free_t4 = models.BooleanField(
        default = False,
        verbose_name = "Free T4"
    )
    free_t4_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    tsh = models.BooleanField(
        default = False,
        verbose_name = "TSH"
    )
    tsh_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    anti_tpo = models.BooleanField(
        default = False,
        verbose_name = "anti-TPO"
    )
    ...
    anti_tg = models.BooleanField(
        default = False,
        verbose_name = "anti-TG"
    )
    anti_tg_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    ...
    psa_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    free_psa = models.BooleanField(
        default = False,
        verbose_name = "Free PSA"
    )
    ...
    tam_idrar = models.BooleanField(
        default = False,
        verbose_name = "Tam İdrar"
    )
    ...
    idrar_kab = models.BooleanField(
        default = False,
        verbose_name = "İdrar KAB"
    )
    ...
    gaita = models.BooleanField(
        default = False,
        verbose_name = "Gaita Direkt Bakısı"
    )
    gaita_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    bogaz_kab = models.BooleanField(
        default = False,
        verbose_name = "Boğaz KAB"
    )
    ...
    ejaculat_kab = models.BooleanField(
        default = False,
        verbose_name = "Ejaculat KAB"
    )
    ...
    ekg = models.BooleanField(
        default = False,
        verbose_name = "EKG"
    )
    ekg_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    eforlu_ekg = models.BooleanField(
        default = False,
        verbose_name = "Eforlu EKG"
    )
    ...
    ekokardiografi = models.BooleanField(
        default = False,
        verbose_name = "Ekokardiografi"
    )
    ...
    tansiyon_holter = models.BooleanField(
        default = False,
        verbose_name = "Tansiyon Holter"
    )
    ...
    ekg_holter = models.BooleanField(
        default = False,
        verbose_name = "EKG Holter"
    )
    ...
    pa_akciger = models.BooleanField(
        default = False,
        verbose_name = "PA Akciğer Grafisi"
    )
    ...
    waters = models.BooleanField(
        default = False,
        verbose_name = "Waters Grafisi"
    )
    waters_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    ...
    ikiyonlu_servikal = models.BooleanField(
        default = False,
        verbose_name = "2 Yönlü Servikal Grafisi"
    )
    ...
    ikiyonlu_lsv = models.BooleanField(
        default = False,
        verbose_name = "2 Yönlü LSV Grafisi"
    )
    ...
    tum_batin = models.BooleanField(
        default = False,
        verbose_name = "Tüm Batın US"
    )
    ...
    ust_batin = models.BooleanField(
        default = False,
        verbose_name = "Üst Batın US"
    )
    ...
    alt_batin = models.BooleanField(
        default = False,
        verbose_name = "Alt Batın US"
    )
    ...
    uriner = models.BooleanField(
        default = False,
        verbose_name = "Üriner US"
    )
    uriner_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    ...
    tiroid = models.BooleanField(
        default = False,
        verbose_name = "Tiroid US"
    )
    tiroid_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    )
    meme = models.BooleanField(
        default = False,
        verbose_name = "Meme US"
    )
    meme_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ' '
    ...
    tiroid_sintigrafi = models.BooleanField(
        default = False,
        verbose_name = "Tiroid Sintigrafisi"
    )
    ...
    aclik_insulin = models.BooleanField(
        default = False,
        verbose_name = "Açlık İnsülin"
    )
    ...
    yuzyirmi_insulin = models.BooleanField(
        default = False,
        verbose_name = "120 dk İnsülin"
    )
    ...
    yirmibesohd = models.BooleanField(
        default = False,
        verbose_name = "25 OH D3"
    )
    ...
    custom1_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ''
    ...
    custom2_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ''
    ...
    custom3_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ''
    ...
    custom4_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ''
    ...
    custom5_sonuc = models.CharField(
        blank = True,
        null = True,
        max_length = 100,
        default = ''
...
class Muayene(models.Model):
    ...
    kullandigi_ilaclar = models.TextField(
        max_length = 512,
        default = ' ',
        blank = True
    )
