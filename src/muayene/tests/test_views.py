...
class MuayeneWeekArchiveViewTestCase(BaseTestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:archive-week", kwargs=kwargs), data
        )
        request.user = self.user
...
class MuayeneMonthArciveViewTestCase(BaseTestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:archive-month", kwargs=kwargs), data
        )
        request.user = self.user
...
class MuayeneYearArchiveViewTestCase(BaseTestCase):
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:archive-year", kwargs=kwargs), data
        )
        request.user = self.user
...
class MuayeneCreateViewTestCase(TestCase):
    ...
    def test_post_with_kwargs(self, *args):
        ...
        request = self.factory.post(
            reverse("hasta:muayene-create", kwargs=kwargs), data
        )
        request.user = self.user
    ...
    def test_ajax(self):
        ...
        request = self.factory.post(
            reverse("muayene:create"), data, HTTP_X_REQUESTED_WITH="XMLHttpRequest"
        )
        request.user = self.user
...
class MuayeneUpdateViewTestCase(BaseTestCase):
    def test_get(self):
        request = self.factory.get(
            reverse("muayene:update", kwargs={"pk": str(self.muayene.pk)})
        )
        request.user = self.user
        ...
        self.assertTrue("form" in response.context_data)
        self.assertEqual(
            response.context_data["form"]["hasta"].initial, self.muayene.hasta.pk
        )
        self.assertEqual(
            response.context_data["form"]["kullandigi_ilaclar"].initial,
            self.muayene.kullandigi_ilaclar,
        )
        self.assertEqual(
            response.context_data["form"]["yakinma"].initial, self.muayene.yakinma
        )
        self.assertEqual(
            response.context_data["form"]["baki"].initial, self.muayene.baki
        )
        self.assertEqual(
            response.context_data["form"]["ontani_tani"].initial,
            self.muayene.ontani_tani,
        )
        self.assertEqual(
            response.context_data["form"]["oneri_gorusler"].initial,
            self.muayene.oneri_gorusler,
        )
        self.assertEqual(
            response.context_data["form"]["ozel_notlar"].initial,
            self.muayene.ozel_notlar,
        )
    ...
    def test_post(self, *args):
        ...
        request = self.factory.post(
            reverse("muayene:update", kwargs={"pk": str(self.muayene.pk)}), data
        )
        request.user = self.user
...
class RecetePrintViewTestCase(BaseTestCase):
    def test_get(self):
        ...
        request = self.factory.get(
            reverse("muayene:recete-print", kwargs={"pk": recete.pk})
        )
        request.user = self.user
        ...
        self.assertEqual(
            response.get("Content-Disposition"), "filename=%s.pdf" % filename
        )
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:recete-print", kwargs={"pk": recete.pk}), data
        )
        request.user = self.user
...
class RaporPrintViewTestCase(BaseTestCase):
    def test_get(self):
        ...
        request = self.factory.get(
            reverse("muayene:rapor-print", kwargs={"pk": rapor.pk})
        )
        request.user = self.user
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:rapor-print", kwargs={"pk": rapor.pk}), data
        )
        request.user = self.user
...
class LabIstekPrintViewTestCase(BaseTestCase):
    def test_get(self):
        ...
        request = self.factory.get(
            reverse("muayene:lab-print", kwargs={"pk": istek.pk})
        )
        request.user = self.user
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:lab-print", kwargs={"pk": istek.pk}), data
        )
        request.user = self.user
...
class TTFPrintViewTestCase(BaseTestCase):
    def test_get(self):
        ...
        request = self.factory.get(
            reverse("muayene:ttf-print", kwargs={"pk": self.muayene.pk})
        )
        request.user = self.user
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:ttf-print", kwargs={"pk": self.muayene.pk}), data
        )
        request.user = self.user
...
class MultiTTFPrintViewTestCase(TestCase):
    def setUp(self):
        ...
        self.muayene2 = MuayeneFactory(
            hasta=self.hasta, tarih=datetime.date.today() - datetime.timedelta(days=1)
        )
        self.muayene3 = MuayeneFactory(
            hasta=self.hasta, tarih=datetime.date.today() - datetime.timedelta(days=2)
        )
...
class AHSevkPrintViewTestCase(BaseTestCase):
    def test_get(self):
        ...
        request = self.factory.get(
            reverse("muayene:ahsevk", kwargs={"pk": self.muayene.pk})
        )
        request.user = self.user
    ...
    def test_post(self):
        ...
        request = self.factory.post(
            reverse("muayene:ahsevk", kwargs={"pk": self.muayene.pk}), data
        )
        request.user = self.user
