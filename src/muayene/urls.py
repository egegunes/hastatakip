...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/tetkik/(?P<id>[0-9]+)/sonuc/$', views.LaboratuvarIstekUpdateView.as_view(), name='lab-sonuc'),
    ...
    url(r'^(?P<year>[0-9]{4})/hafta/(?P<week>[0-9]+)/$', views.MuayeneWeekArchiveView.as_view(), name='archive-week'),
    url(r'^(?P<year>[0-9]{4})/(?P<month>[0-9]+)/$', views.MuayeneMonthArciveView.as_view(), name='archive-month'),
    url(r'^(?P<year>[0-9]{4})/$', views.MuayeneYearArchiveView.as_view(), name='archive-year'),
    ...
    url(r'^recete/(?P<pk>[0-9]+)/print/$', views.RecetePrintView.as_view(), name='recete-print'),
