...
from muayene.models                 import Muayene, Recete, Rapor, Ilac, LaboratuvarIstek, MuayeneAlias
...
class ReceteFactory(factory.django.DjangoModelFactory):
    ...
    ilac4_kullanim = 'İLAÇ 1 KULLANIM'
    ilac4_kutu = 1
    ilac5 = factory.SubFactory(IlacFactory)
    ilac5_kullanim = 'İLAÇ 1 KULLANIM'
    ilac5_kutu = 1
...
class MuayeneAliasFactory(factory.django.DjangoModelFactory):
    class Meta:
        model = MuayeneAlias

    shorthand = 'nsm'
    longhand = 'Normal sistemik muayene'
