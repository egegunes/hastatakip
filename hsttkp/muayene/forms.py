...
from muayene.models             import Muayene, Ilac, Recete, Rapor, LaboratuvarIstek, Laboratuvar, MuayeneRelatedFile, MuayeneAlias
...
class ReceteCreateForm(forms.Form):
    ...
    ilac1 = forms.ModelChoiceField(
        ...
        widget = autocomplete.ModelSelect2(url='IlacAutocomplete', attrs={'class': 'ilac_select2'}),
    )
    ilac1_kullanim = forms.CharField(
        max_length = 100,
        required = True,
        widget = forms.widgets.TextInput(attrs = {'class': 'form-control ilac_kullanim', 'placeholder': 'Kullanım'}),
    )
...
class DateRangeForm(forms.Form):
    ...
    start_date = forms.DateField(
        widget = forms.widgets.DateInput(attrs = {'class': 'form-control datepicker input-sm', 'name': 'start', 'placeholder': 'Başlangıç tarihi'}),
        required = True
    ) 
    end_date = forms.DateField(
        widget = forms.widgets.DateInput(attrs = {'class': 'form-control datepicker input-sm', 'name': 'end', 'placeholder': 'Bitiş tarihi'}),
        required = True
    ) 
